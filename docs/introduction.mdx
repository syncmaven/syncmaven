...
*Syncmaven* is an open-source framework for synchronizing data from database to external services. It also called
*Reverse-ETL* or *Data Activation*. If you familiar with [DBT](getdbt.com),
think of Syncmaven as DBT equivalent for saving modelling results to external services.

## Use Cases

- **CRM**: Syncmaven can be used to sync your customers from your database to CRM platforms like Salesforce, Hubspot, or Intercom.f
